    ...
    <div class="row">
       <div v-if="showTab === 1" class="tabsBlock col-12">
         <div class="b-radius bg-white">
           <FileUpload  :customUpload="true" @uploader="myUploaderDoc"  mode="advanced" :showCancelButton="false"  :showUploadButton="true"  :multiple="true" :maxFileSize="3145728">
           </FileUpload>
...
export default {
  ...
  methods: {
    ...
    myUploaderDoc(event) {
      ...
      formData.append('type', this.showTab);
      //Файлы
